...
class DistanceAndBearing {
  ...
  static LatLng destinationPointByDistanceAndBearing(LatLng l, num distance, num bearing, [num? radius]) {
    ...
    final sinLatRadians2 = sinLatRadians * cosAngularDistanceRadius + cosLatRadians * sinAngularDistanceRadius * cosBearingRadians;
    ...
    return LatLng(radianToDeg(latRadians2 as double), (radianToDeg(lngRadians2 as double) + 540) % 360 - 180);
  }
}
